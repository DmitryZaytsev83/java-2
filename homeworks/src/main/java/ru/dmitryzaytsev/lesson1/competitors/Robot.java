...
public class Robot implements IOvercomingObstacles {
    ...
    public Robot(String name, IRunnable runnable, IJumpable jumpable) {
        this.name = name;
        this.maxRunLength = new Random().nextInt(9) * 100 + 200;
        maxJumpHeight = new Random().nextInt(5) + 1;
